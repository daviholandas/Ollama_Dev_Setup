...
class VLLMSetup:
    ...
    def __init__(self):
        ...
        self.tools_dir = self.project_root / "src/tools"
        self.outputs_dir = self.project_root / "src/outputs"
        self.logs_dir = self.project_root / "src/logs"
        self.workspace_dir = self.project_root / "src/workspace"
    ...
    def log(self, message: str, level: str = "INFO") -> None:
        ...
        print(f"{prefixes.get(level, 'ℹ️')} {message}")
    ...
    def setup_api_key(self) -> str:
            ...
            with open(env_file) as f:
                ...
                if "VLLM_API_KEY=" in content:
                    ...
                    if api_key and api_key != "your-secret-api-key-here":
                        self.log("✓ Using existing API key from .env", "SUCCESS")
                        return api_key
        ...
        self.log("✓ Generated and saved API key to .env", "SUCCESS")
        self.log(f"  API Key: {api_key}", "INFO")
        self.log("  📝 Save this key for your API clients", "WARNING")
        
        return api_key

    def run_command(self, cmd: List[str], check: bool = True, capture: bool = False, timeout: int = 450) -> Tuple[int, str, str]:
    ...
    def check_prerequisites(self) -> bool:
        ...
        if code == 0:
            ...
            self.log("✗ NVIDIA GPU not found", "ERROR")
            checks.append(False)
        ...
        if code == 0:
            self.log("✓ NVIDIA Container Toolkit configured", "SUCCESS")
            checks.append(True)
        else:
            self.log("✗ NVIDIA Container Toolkit not configured", "ERROR")
        ...
        if code == 0:
            self.log("✓ Docker Compose available", "SUCCESS")
            checks.append(True)
        else:
    ...
    def create_tool_definitions(self) -> None:
        ...
        self.log(f"✓ Created {len(tools_map)} tool definition files", "SUCCESS")
    ...
    def create_docker_compose(self, api_key: str) -> None:
        ...
        self.log("✓ docker-compose.yml created", "SUCCESS")
    ...
    def install(self) -> bool:
        ...
        print("\\n" + "="*60)
        print("🚀 VLLM Local Setup - Installation")
        print("="*60 + "\\n")
        ...
        if code == 0:
            self.log("✓ Docker image ready", "SUCCESS")
        else:
        ...
        print("\\n🤖 Agents (Updated with >47k context!):")
    ...
    def start_agent(self, agent_name: str) -> bool:
        ...
        for i in range(120):
            ...
            if code == 0:
                self.log(f"✓ {agent_name.upper()} ready at http://localhost:{config.port}", "SUCCESS")
                if api_key:
                    self.log(f"🔑 API Key: {api_key}", "INFO")
    ...
    def stop_all(self) -> None:
        ...
        self.log("✓ All agents stopped", "SUCCESS")
